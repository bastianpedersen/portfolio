                            ...
                            <AnimatePresence>
                                {open && (
                                    <Listbox.Options
                                        ...
                                        className="absolute right-0 p-2 mt-2 overflow-auto text-base origin-top-right shadow-lg max-h-60 w-42 rounded-xl focus:outline-none sm:text-sm capitalize"
                                    >
                                        {themes.map((theme) => (
                                            <Listbox.Option
                                                key={theme}
